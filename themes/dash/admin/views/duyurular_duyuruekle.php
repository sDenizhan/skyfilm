<div class="row">
    <div class="col-sm-12 col-md-12 col-lg-12">
        <div class="block-flat">
            ...
            <div class="content">
                <form class="form-horizontal" method="post" action="<?php echo base_url('admin/duyurular/duyurukaydet'); ?>" role="form">
                    <div class="form-group">
                        <label for="frmHaberBaslik" class="col-sm-2 control-label">Duyuru Başlık:</label>
                        <div class="col-sm-10">
                            <?php echo form_input('frmHaberBaslik','','class="form-control"'); ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea rows="10" cols="100%" name="frmHaberIcerik" class="form-control" id="ckeditor"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <?php echo form_dropdown('frmTur', $tur, '', 'class="form-control"'); ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <?php echo form_upload('frmHaberResim', '','class="form-control"'); ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <?php echo form_input('frmEtiket', '','class="form-control"'); ?>
                        </div>
                    </div>
