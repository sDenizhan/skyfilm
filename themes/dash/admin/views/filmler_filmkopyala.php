...
<div class="content">
    <form class="form-horizontal" method="post" action="<?php echo base_url('admin/filmler/filmkopyalakaydet/'. $_film->id .'/'.seoURL($_film->film_adi) .''); ?>" role="form">
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
                <button type="submit" class="btn btn-primary ajaxFilmEkle">Filmi Kopyala</button>
            </div>
        </div>
    </form>
</div>
